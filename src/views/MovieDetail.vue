...
const moviesData = [
  ...
  { id: 10, title: "Виноваты звезды ", rating: 7.8, genre: "Драмы", poster: "/images/vinovati_zvezdi.jpg", description: "Виноваты звезды — это трогательная история о любви двух подростков, которые встречаются на группе поддержки для больных раком. Фильм исследует темы жизни, смерти и силы любви, ставя перед героями непростые вопросы о смысле существования." },
  ...
  { id: 12, title: "Гадкий я 4", rating: 6.9, genre: "Мультфильмы", poster: "/images/gadkiy_ya.jpg", description: "Гадкий я 4 продолжает приключения Грю и его детей. В этом фильме Грю сталкивается с новыми вызовами и противниками, а также с необходимостью справиться со своей задачей как хорошего отца и злодея. Чудесные моменты, забавные миньоны и эмоциональные отношения делают фильм ярким и увлекательным." },
...
onMounted(() => {
  ...
  movie.value = moviesData.find(m => m.id === movieId);
});

const getPosterUrl = (path) => {
  return path ? path : '/images/no-image.jpg';
};
